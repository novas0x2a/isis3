...
int main (void)
{
  ...
  try{
    ...
    double knownLat = -29.57162533079739;
    double knownLon = 257.0479397165627;

    Isis::Pvl p("$cassini/testData/N1477312678_2.cub");
    Isis::Camera *cam = Isis::CameraFactory::Create(p);
    cout << setprecision(9);
   
    // Test all four corners to make sure the conversions are right
    cout << "For upper left corner ..." << endl;
    TestLineSamp(cam, 135.0, 160.0);

    cout << "For upper right corner ..." << endl;
    TestLineSamp(cam, 350.0, 160.0);

    cout << "For lower left corner ..." << endl;
    TestLineSamp(cam, 200.0, 300.0);
