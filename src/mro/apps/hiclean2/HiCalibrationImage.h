#ifndef HiCalibrationImage_h
#define HiCalibrationImage_h
/**                                                                       
 * @file                                                                  
 * $Revision: 1.2 $                                                             
 * $Date: 2008/05/12 18:17:34 $
 *                                                                        
...
/**                                                   
 * @brief HiRISE Calibration Image buffer class
 *  
 * This class provides access and processing of HiRISE calibration image
 ...
 * an ISIS Table named "HiRISE Calibration Image".  From that table, data
 * is extracted from the "Calibration" field.
 * 
 ...
 */
  class HiCalibrationImage : public Blobber {

    public:
      /**
       * @brief Default, mostly useless constructor
       */
      HiCalibrationImage(): Blobber() { }
      /**
       * @brief Constructor providing interface to an ISIS Cube object
       */
      HiCalibrationImage(Cube &cube) : 
        Blobber(cube,"HiRISE Calibration Image", "Calibration", 
                      "CalibrationImage") { }
      /** Destructor */
      virtual ~HiCalibrationImage() { }
   };
};
