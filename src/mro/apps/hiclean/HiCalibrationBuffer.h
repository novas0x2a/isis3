#ifndef HiCalibrationBuffer_h
#define HiCalibrationBuffer_h
/**                                                                       
 * @file                                                                  
 * $Revision: 1.2 $                                                             
...
/**                                                   
 * @brief HiRISE Calibration buffer pixels class
 *  
 * This class provides access and processing of HiRISE calibration buffer picels
 ...
 * is extracted from the "BufferPixels" field.
 * 
 ...
 */
  class HiCalibrationBuffer : public Blobber {

    public:
      /**
       * @brief Default, mostly useless constructor
       */
      HiCalibrationBuffer() : Blobber() { }
      /**
       * @brief Constructor providing interface to an ISIS Cube object
       */
      HiCalibrationBuffer(Cube &cube) : 
        Blobber(cube,"HiRISE Calibration Ancillary","BufferPixels",
                     "CalibrationBuffer") { }
      /** Destructor */
      virtual ~HiCalibrationBuffer() { }
   };
};
