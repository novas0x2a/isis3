#ifndef HiAncillaryBuffer_h
#define HiAncillaryBuffer_h
/**                                                                       
 * @file                                                                  
 * $Revision: 1.2 $                                                             
...
/**                                                   
 * @brief HiRISE Ancillary Buffer class
 *  
 * This class provides access and processing of HiRISE ancillary buffer
 ...
 */
  ...
  class HiAncillaryBuffer : public Blobber {

    public:
      /**
       * @brief Default, mostly useless constructor
       */
      HiAncillaryBuffer() : Blobber() { }
      /**
       * @brief Constructor providing interface to an ISIS Cube object
       */
      HiAncillaryBuffer(Cube &cube) : 
        Blobber(cube,"HiRISE Ancillary","BufferPixels","AncillaryBuffer") {  }
      /** Destructor */
      virtual ~HiAncillaryBuffer() { }
   };
};
