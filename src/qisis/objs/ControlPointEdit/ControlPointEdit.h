...
/**
  ...
  *            createPointEditor() to allow the leftChipViewport
  *            to refresh even if allowLeftMouse = false.
  *   @history 2008-12-10 Jeannie Walldren - Added a private
  *            variable for the template filename.  Set the
  *            default value of this variable to the previously hard-coded
  *            template filename. Added setTemplateFile() method
  *            derived from previously unused and commented out
  *            method called openTemplateFile().
  *   @history 2008-12-15 Jeannie Walldren - Some QMessageBox
  *            warnings had strings tacked on to the list of
  *            errors.  These strings were changed to
  *            iExceptions and added to the error stack to
  *            conform with Isis standards.
