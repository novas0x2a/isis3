...
namespace Qisis {
  ...
  class MosaicItem : public QGraphicsPolygonItem {
    ...
    public:
       ...
       */
      Isis::Filename filename() const { return p_filename; };
       ...
       * @return std::string 
       */
      std::string serialNumber() { return p_serialNumber; };
       ...
       */
      QList<QPointF> controlPoints(){ return p_controlPoints; };
      QMap<QString, QPointF> pointsMap() { return p_sceneToPointMap; };
       ...
       * @return double 
       */
      double YMaximum() const { return p_ymax; };
       ...
       * @return double 
       */
      double XMaximum() const { return p_xmax; };
       ...
       * @return double 
       */
      double YMinimum() const { return p_ymin; };
       ...
       * @return double 
       */
      double XMinimum() const { return p_xmin; };
       ...
       * @return double 
       */
      double pixelResolution() const { return p_pixRes; };
       ...
       */
      Isis::Projection* getProj() const { return p_proj; }
      Isis::Cube* cube() { return &p_cube; }      
       ...
       */
      Isis::UniversalGroundMap* getGroundMap() const { return p_groundMap; }
       ...
       * @return bool 
       */
      bool crossBoundry() const { return p_crossesBoundry; }
       ...
       * @return MosaicItem* 
       */
      MosaicItem* getSecondItem() const { return p_secondItem; }
       ...
       * @return bool 
       */
      bool isTreeItemSelected() { return p_treeItem->isSelected(); };

      QTreeWidgetItem* treeWidgetItem() { return p_treeItem; };
    ...
    protected:
       ...
       */
      QTreeWidgetItem *treeItem() { return p_treeItem; };
