...
namespace Qisis {
  ...
  WindowTool::WindowTool (QWidget *parent) : Qisis::Tool(parent) {
    ...
    connect(p_closeAllWindows,SIGNAL(activated()),this,SLOT(closeAllWindows()));
   ...
   * @param cvp 
   */
  void WindowTool::addConnections(CubeViewport *cvp) {
   ...
   * @param cvp 
   */
  void WindowTool::removeConnections(CubeViewport *cvp) {
  ...
  /**
   * Closes all the viewport windows.
   * 
   */
  void WindowTool::closeAllWindows() {
