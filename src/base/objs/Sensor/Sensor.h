 ...
 */
  class Sensor : public Isis::Spice {
    public:
      ...
      */
      inline bool HasSurfaceIntersection () const { return p_hasIntersection; };
      ...
      */
      inline double UniversalLatitude () const { return p_latitude; };

     /**
      * Returns a positive east, 0-360 domain longitude.
      */
      inline double UniversalLongitude () const { return p_longitude; };
      ...
      */
      inline double LocalRadius () const { return p_radius * 1000.0; };
