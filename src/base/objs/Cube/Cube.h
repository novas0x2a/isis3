...
*/
  class Cube {
    public:
      ...
      */
      bool IsOpen () { return p_cube.stream.is_open(); };
      ...
      */                                                                       
      bool IsReadOnly () const { return p_cube.access == IsisCubeDef::ReadOnly; };
      ...
      */                                                                       
      bool IsReadWrite () const { return p_cube.access == IsisCubeDef::ReadWrite; };
      ...
      */                                                                       
      inline std::string Filename() const { return p_cube.labelFile; };
      ...
      */                                                                       
      inline Isis::Pvl *Label() { return &p_cube.label; };
      ...
      */                                                                             
      inline int LabelBytes () const { return p_cube.labelBytes; };
      int LabelBytesUsed();
      ...
      */                                                                       
      inline int Samples () const { return p_cube.samples; };
      ...
      */
      inline int Lines () const { return p_cube.lines; };                                                                      
      int Bands () const;
      ...
      */                                                                       
      inline Isis::PixelType PixelType () const { return p_cube.pixelType; };
      ...
      */                                                                       
      inline Isis::CubeFormat CubeFormat () const { return p_cube.cubeFormat; };
      ...
      */                                                                       
      inline Isis::ByteOrder ByteOrder () const { return p_cube.byteOrder; };
      ...
      */                                                                       
      inline bool IsAttached () const { return p_cube.attached; };
      ...
      */                                                                       
      inline bool IsDetached () const { return !p_cube.attached; };
      ...
      *                32-bit.
      */                                                                       
      inline double Base () const { return p_cube.base; };
      ...
      *                to 32-bit.                                      
      */                                                                       
      inline double Multiplier () const { return p_cube.multiplier; };
