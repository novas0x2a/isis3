...
namespace Isis {
  ...
  class PvlObject : public Isis::PvlContainer {
    public:
       ...
       */
      int Groups () const { return p_groups.size(); };
       ...
       */
      PvlGroupIterator BeginGroup() { return p_groups.begin(); };
       ...
       * @return The iterator of the beginning group..
       */
      ConstPvlGroupIterator BeginGroup() const { return p_groups.begin(); };
       ...
       */
      PvlGroupIterator EndGroup() { return p_groups.end(); };
       ...
       * @return The iterator of the ending group.
       */
      ConstPvlGroupIterator EndGroup() const { return p_groups.end(); };
      ...
      void operator+= (const Isis::PvlGroup &group) { AddGroup(group); }
      void operator+= (const Isis::PvlObject &obj) { AddObject(obj); }
       ...
       */
      int Objects () const { return p_objects.size(); };
       ...
       */
      PvlObjectIterator BeginObject() { return p_objects.begin(); };
       ...
       * @return The beginning object's index.
       */
      ConstPvlObjectIterator BeginObject() const { return p_objects.begin(); };
       ...
       */
      PvlObjectIterator EndObject() { return p_objects.end(); };
       ...
       * @return The ending object's index.
       */
      ConstPvlObjectIterator EndObject() const { return p_objects.end(); };
      ...
      void Clear() {
        Isis::PvlContainer::Clear(); p_objects.clear(); p_groups.clear();
      }
