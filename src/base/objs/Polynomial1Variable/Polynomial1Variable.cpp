...
#include "Polynomial1Variable.h"
#include "iString.h"
#include "iException.h"

namespace Isis {
 /** 
  * Create a Polynomial1Variable object    
  * 
  * @param degree The order/degree of the polynomial
  * 
  */
  Polynomial1Variable::Polynomial1Variable(int degree) : 
           Isis::Basis1VariableFunction("Polynomial1Variable",(degree + 1)) {
    p_degree = degree;
  }
  ...
  */
  void Polynomial1Variable::Expand(const std::vector<double> &vars) {
    p_terms.clear();
   ...
   *  
   */
  double Polynomial1Variable::DerivativeVar(const double value) {
   ...
   *
   */
  double Polynomial1Variable::DerivativeCoef (const double value,
                                              const int coefIndex) {
    double derivative;
