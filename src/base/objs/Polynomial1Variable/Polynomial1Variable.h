#ifndef Polynomial1Variable_h
#define Polynomial1Variable_h
/**                                                                       
 * @file                                                                  
 * $Revision: 1.1 $                                                             
 ...
 * @ingroup Math                                                  
 *                                                                        
 * @author  Debbie A. Cook 2007-11-19 (modified from Poly2D 2004-06-24 Jeff Anderson)                                    
 *                                                                        
 * @internal                                                              
 *                                                                        
 ...
 */                                                                       
  ...
  class Polynomial1Variable : public Isis::Basis1VariableFunction {
    public:
      Polynomial1Variable(int degree);

      //! Destroys the Polynomial1Variable object
      ~Polynomial1Variable() {};
