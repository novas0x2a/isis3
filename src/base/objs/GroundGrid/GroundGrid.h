...
namespace Isis {
  ...
  class GroundGrid {
    ...
    protected:
      ...
      UniversalGroundMap *GroundMap() { return p_groundMap; }

    private:
      void SetGridBit(unsigned int x, unsigned int y);
      bool GetGridBit(unsigned int x, unsigned int y);
