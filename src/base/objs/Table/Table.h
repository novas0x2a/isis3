 ...
 */
  class Table : public Isis::Blob {
    public:
      ...
      */
      inline int Records () const { return p_recbufs.size(); };
      ...
      */
      inline int RecordSize () const { return p_record.RecordSize(); };
      ...
      */
      bool IsSampleAssociated () { return (p_assoc== Table::Samples); };
      ...
      */
      bool IsLineAssociated () { return (p_assoc== Table::Lines); };
      ...
      */
      bool IsBandAssociated () { return (p_assoc== Table::Bands); };
