 ...
 */                                                                       
  class Buffer {
    public:
      ...
      * @return int
      */
      inline int SampleDimension() const { return (p_nsamps); }
      ...
      * @return int
      */
      inline int LineDimension() const { return (p_nlines); }
      ...
      * @return int
      */
      inline int BandDimension() const { return (p_nbands); }
      ...
      * @return int
      */
      inline int size() const { return (p_npixels); }
      ...
      * @return double&
      */
      inline double &operator[](const int index) { return (p_buf[index]); }
      ...
      */
      inline double *DoubleBuffer() const { return (p_buf); };
      ...
      */
      void *RawBuffer() const { return p_rawbuf; };
      ...
      */
      Isis::PixelType PixelType () const { return p_pixelType; };
